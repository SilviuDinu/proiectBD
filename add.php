...
//    TODO
    ...
    mysqli_query($con,"DELETE FROM telefoane WHERE brand_ID=(SELECT brand_ID FROM brand WHERE nume_brand='$brand') AND model_ID=(SELECT model_ID FROM model WHERE nume_model='$model') and telefon='$telefon'");
